...
verify_full(void)
{
  ...
  unsigned char pkA_hex[CURVE25519_KEY_LEN_HEX+1], pkB_hex[CURVE25519_KEY_LEN_HEX+1];
  unsigned char skA_hex[CURVE25519_KEY_LEN_HEX+1], skB_hex[CURVE25519_KEY_LEN_HEX+1];

  PublicKey_export_hex(pkA,(unsigned char *)&pkA_hex,CURVE25519_KEY_LEN_HEX+1);
  PublicKey_export_hex(pkB,(unsigned char *)&pkB_hex,CURVE25519_KEY_LEN_HEX+1);

  PrivateKey_export_hex(skA,(unsigned char *)&skA_hex,CURVE25519_KEY_LEN_HEX+1);
  PrivateKey_export_hex(skB,(unsigned char *)&skB_hex,CURVE25519_KEY_LEN_HEX+1);
